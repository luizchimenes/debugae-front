...
import { ChevronDown, Search, Filter, FolderOpen, Eye, X } from "lucide-react";
    ...
    <div className="w-full space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Projetos</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {table.getFilteredRowModel().rows.length} projeto(s) encontrado(s)
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-400">Filtros avançados</span>
            </div>

            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="gap-2 dark:border-gray-600 dark:text-gray-300 dark:hover:text-gray-100 dark:hover:border-gray-400">
              ...
              table.getRowModel().rows.map((row, index) => (
                <TableRow
                  ...
                  onClick={() => {
                    ...
                    router.push(`/www/project/view/${projectId}`);
                  }}
                >
