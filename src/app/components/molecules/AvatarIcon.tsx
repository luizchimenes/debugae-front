...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "../atoms/DropdownMenuComponent";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="flex items-center justify-between px-2 py-1 rounded-lg border w-full max-w-[160px] bg-white dark:bg-gray-800 text-sm cursor-pointer">
